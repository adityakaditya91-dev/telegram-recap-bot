...
def summarize_with_gemini(messages):
    ...
    content = (
        ...
        "7. Avoid referring to \"messages\" in your wording. Instead, refer to \"links\", \"articles\", or \"items\".\n"
        "8. Keep the total length under 450 words.\n"
        "9. Write in a concise, non‑jargony tone suitable for someone who has been a CEO or senior leader "
...
if __name__ == "__main__":
    ...
    recap = summarize_with_gemini(msgs)
